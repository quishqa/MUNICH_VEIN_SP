...
pin_coords_file <- "./02_data/emiss/PINUGS.traf.2014100800"
...
pin_mun_uc <- LoadMunichOutputStreet2LT("02_data/tests/pin_ugs/", "201410",
...
svg("03_output/paper_figs/Fig_07_Pin_control_case.svg", width = 14, height = 10)
par(mfrow = c(2, 2), mar=c(3.2,4.6, 1.5, 0.7))
...
per_stats <- AllPerformaceTable(mun_obs, pin_mun_uc, "./03_output/text_files/pin_ugs")
per_stats[, c("COE", "IOA")]
bg_stats <- AllPerformaceTable(mun_obs, mun_bg_ibi, "./03_output/text_files/pin_bg_ugs")
